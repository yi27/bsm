...
# keyword "_n" is Bsm frontend plural function
# keyword "_s" is Bsm frontend placeholder function
# keyword "_x" is Bsm frontend context function
xgettext --files-from=locale/POTFILES.in --from-code=UTF-8 \
--output=locale/frontend.pot \
--copyright-holder="Bsm SIA" --no-wrap --sort-output \
