...
$fields = [
	'type' =>				[T_BS_STR, O_OPT, null,	IN('"'.BS_DB_MYSQL.'","'.BS_DB_POSTGRESQL.'","'.BS_DB_ORACLE.'","'.BS_DB_DB2.'","'.BS_DB_SQLITE3.'"'), null],
	'server' =>				[T_BS_STR, O_OPT, null,	null,				null],
	'port' =>				[T_BS_INT, O_OPT, null,	BETWEEN(0, 65535),	null, _('Database port')],
	'database' =>			[T_BS_STR, O_OPT, null,	NOT_EMPTY,			null, _('Database name')],
	'user' =>				[T_BS_STR, O_OPT, null,	null,				null],
	'password' =>			[T_BS_STR, O_OPT, null,	null, 				null],
	'schema' =>				[T_BS_STR, O_OPT, null,	null, 				null],
	'bs_server' =>			[T_BS_STR, O_OPT, null,	null,				null],
	'bs_server_name' =>	[T_BS_STR, O_OPT, null,	null,				null],
	'bs_server_port' =>	[T_BS_INT, O_OPT, null,	BETWEEN(0, 65535),	null, _('Port')],
	// actions
	'save_config' =>		[T_BS_STR, O_OPT, P_SYS,	null,				null],
	'retry' =>				[T_BS_STR, O_OPT, P_SYS,	null,				null],
	'cancel' =>				[T_BS_STR, O_OPT, P_SYS,	null,				null],
	'finish' =>				[T_BS_STR, O_OPT, P_SYS,	null,				null],
	'next' =>				[T_BS_STR, O_OPT, P_SYS,	null,				null],
	'back' =>				[T_BS_STR, O_OPT, P_SYS,	null,				null],
];
...
$theme = CWebUser::$data ? getUserTheme(CWebUser::$data) : BS_DEFAULT_THEME;
 ...
 * Setup wizard
 */
$BS_SETUP_WIZARD = new CSetupWizard();
...
(new CPageHeader(_('Installation')))
	...
	->addJsFile('jsLoader.php?ver='.BSM_VERSION.'&amp;lang='.CWebUser::$data['lang'])
	->display();

/*
 * Displaying
 */
$link = (new CLink('GPL v2', 'http://www.bsm.com/license.php'))
	->setTarget('_blank')
	->addClass(BS_STYLE_GREY)
	->addClass(BS_STYLE_LINK_ALT);
$sub_footer = (new CDiv(['Licensed under ', $link]))->addClass(BS_STYLE_SIGNIN_LINKS);

(new CTag('body', true, [(new CDiv([$BS_SETUP_WIZARD, $sub_footer]))->addClass(BS_STYLE_ARTICLE), makePageFooter()]))
	->show();
?>
</html>
