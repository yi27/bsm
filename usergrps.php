...
$fields = [
	// group
	'usrgrpid' =>			[T_BS_INT, O_OPT, P_SYS,	DB_ID,		'isset({form}) && {form} == "update"'],
	'group_groupid' =>		[T_BS_INT, O_OPT, P_SYS,	DB_ID,		null],
	'selusrgrp' =>			[T_BS_INT, O_OPT, P_SYS,	DB_ID,		null],
	'gname' =>				[T_BS_STR, O_OPT, null,	NOT_EMPTY,	'isset({add}) || isset({update})', _('Group name')],
	'users' =>				[T_BS_INT, O_OPT, P_SYS,	DB_ID,		null],
	'gui_access' =>			[T_BS_INT, O_OPT, null,	IN('0,1,2'),'isset({add}) || isset({update})'],
	'users_status' =>		[T_BS_INT, O_OPT, null,	IN([GROUP_STATUS_ENABLED, GROUP_STATUS_DISABLED]),	null],
	'debug_mode' =>			[T_BS_INT, O_OPT, null,	IN('1'),	null],
	'new_right' =>			[T_BS_STR, O_OPT, null,	null,		null],
	'right_to_del' =>		[T_BS_STR, O_OPT, null,	null,		null],
	'group_users_to_del' =>	[T_BS_STR, O_OPT, null,	null,		null],
	'group_users' =>		[T_BS_STR, O_OPT, null,	null,		null],
	'group_rights' =>		[T_BS_STR, O_OPT, null,	null,		null],
	'set_gui_access' =>		[T_BS_INT, O_OPT, null,	IN('0,1,2'),null],
	// actions
	...
	'del_read_only' =>		[T_BS_STR, O_OPT, P_SYS|P_ACT, null,	null],
	'del_read_write' =>		[T_BS_STR, O_OPT, P_SYS|P_ACT, null,	null],
	'del_deny' =>			[T_BS_STR, O_OPT, P_SYS|P_ACT, null,	null],
	'del_group_user' =>		[T_BS_STR, O_OPT, P_SYS|P_ACT, null,	null],
	'add_read_only' =>		[T_BS_STR, O_OPT, P_SYS|P_ACT, null,	null],
	'add_read_write' =>		[T_BS_STR, O_OPT, P_SYS|P_ACT, null,	null],
	'add_deny' =>			[T_BS_STR, O_OPT, P_SYS|P_ACT, null,	null],
	...
	if (isset($_REQUEST['usrgrpid']) && !isset($_REQUEST['form_refresh'])) {
		...
		$dbUsers = DBselect(
			...
			' WHERE u.userid=ug.userid '.
				' AND ug.usrgrpid='.bs_dbstr($data['usrgrpid'])
		);
		...
		$dbRights = DBselect(
			...
			' WHERE r.groupid='.bs_dbstr($data['usrgrpid'])
		);
	...
	if ($data['selected_usrgrp'] > 0) {
		...
		$sqlWhere =
			' WHERE '.dbConditionInt('u.userid', $data['group_users']).
				' OR (u.userid=g.userid AND g.usrgrpid='.bs_dbstr($data['selected_usrgrp']).')';
	}
	else {
		$sqlFrom = '';
		$sqlWhere = '';
