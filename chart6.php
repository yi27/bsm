...
$fields = [
	'graphid' =>		[T_BS_INT, O_MAND, P_SYS,		DB_ID,		null],
	'period' =>			[T_BS_INT, O_OPT, P_NZERO,	BETWEEN(BS_MIN_PERIOD, BS_MAX_PERIOD), null],
	'stime' =>			[T_BS_STR, O_OPT, P_SYS,		null,		null],
	'profileIdx' =>		[T_BS_STR, O_OPT, null,		null,		null],
	'profileIdx2' =>	[T_BS_STR, O_OPT, null,		null,		null],
	'updateProfile' =>	[T_BS_STR, O_OPT, null,		null,		null],
	'width' =>			[T_BS_INT, O_OPT, P_NZERO,	BETWEEN(20, 65535),	null],
	'height' =>			[T_BS_INT, O_OPT, P_NZERO,	'{} > 0',	null],
...
CArrayHelper::sort($dbGraph['gitems'], [
	['field' => 'sortorder', 'order' => BS_SORT_UP],
	['field' => 'itemid', 'order' => BS_SORT_DOWN]
]);
