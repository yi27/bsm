...
$fields = [
	'hk_events_mode' =>		[T_BS_INT, O_OPT, null, IN('1'), null, _('Enable internal housekeeping')],
	'hk_events_trigger' => 	[T_BS_INT, O_OPT, null, BETWEEN(1, 99999),
		'isset({update}) && isset({hk_events_mode})', _('Trigger event and alert data storage period')
	],
	'hk_events_internal' => [T_BS_INT, O_OPT, null, BETWEEN(1, 99999),
		'isset({update}) && isset({hk_events_mode})', _('Internal event and alert data storage period')
	],
	'hk_events_discovery' =>[T_BS_INT, O_OPT, null, BETWEEN(1, 99999),
		'isset({update}) && isset({hk_events_mode})', _('Network discovery event and alert data storage period')
	],
	'hk_events_autoreg' => 	[T_BS_INT, O_OPT, null, BETWEEN(1, 99999),
		'isset({update}) && isset({hk_events_mode})', _('Auto-registration event and alert data storage period')
	],
	'hk_services_mode' =>	[T_BS_INT, O_OPT, null, IN('1'), null, _('Enable internal housekeeping')],
	'hk_services' => 		[T_BS_INT, O_OPT, null, BETWEEN(1, 99999),
		'isset({update}) && isset({hk_services_mode})', _('IT service data storage period')
	],
	'hk_audit_mode' =>		[T_BS_INT, O_OPT, null, IN('1'), null, _('Enable internal housekeeping')],
	'hk_audit' => 			[T_BS_INT, O_OPT, null, BETWEEN(1, 99999),
		'isset({update}) && isset({hk_audit_mode})', _('Audit data storage period')
	],
	'hk_sessions_mode' =>	[T_BS_INT, O_OPT, null, IN('1'), null, _('Enable internal housekeeping')],
	'hk_sessions' => 		[T_BS_INT, O_OPT, null, BETWEEN(1, 99999),
		'isset({update}) && isset({hk_sessions_mode})', _('User session data storage period')],
	'hk_history_mode' =>	[T_BS_INT, O_OPT, null, IN('1'), null, _('Enable internal housekeeping')],
	'hk_history_global' =>	[T_BS_INT, O_OPT, null, IN('1'), null, _('Override item history period')],
	'hk_history' => 		[T_BS_INT, O_OPT, null, BETWEEN(0, 99999),
		'isset({update}) && isset({hk_history_global})', _('History data storage period')
	],
	'hk_trends_mode' =>		[T_BS_INT, O_OPT, null, IN('1'), null, _('Enable internal housekeeping')],
	'hk_trends_global' =>	[T_BS_INT, O_OPT, null, IN('1'), null, _('Override item history period')],
	'hk_trends' => 			[T_BS_INT, O_OPT, null, BETWEEN(0, 99999),
