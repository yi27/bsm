...
$fields = [
	'severity_name_0' =>	[T_BS_STR, O_OPT, null, NOT_EMPTY, 'isset({update})', _('Not classified')],
	'severity_color_0' =>	[T_BS_CLR, O_OPT, null, null, 'isset({update})', _('Not classified')],
	'severity_name_1' =>	[T_BS_STR, O_OPT, null, NOT_EMPTY, 'isset({update})', _('Information')],
	'severity_color_1' =>	[T_BS_CLR, O_OPT, null, null, 'isset({update})', _('Information')],
	'severity_name_2' =>	[T_BS_STR, O_OPT, null, NOT_EMPTY, 'isset({update})', _('Warning')],
	'severity_color_2' =>	[T_BS_CLR, O_OPT, null, null, 'isset({update})', _('Warning')],
	'severity_name_3' =>	[T_BS_STR, O_OPT, null, NOT_EMPTY, 'isset({update})', _('Average')],
	'severity_color_3' =>	[T_BS_CLR, O_OPT, null, null, 'isset({update})', _('Average')],
	'severity_name_4' =>	[T_BS_STR, O_OPT, null, NOT_EMPTY, 'isset({update})', _('High')],
	'severity_color_4' =>	[T_BS_CLR, O_OPT, null, null, 'isset({update})', _('High')],
	'severity_name_5' =>	[T_BS_STR, O_OPT, null, NOT_EMPTY, 'isset({update})', _('Disaster')],
	'severity_color_5' =>	[T_BS_CLR, O_OPT, null, null, 'isset({update})', _('Disaster')],
	// actions
