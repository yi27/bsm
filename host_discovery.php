...
$fields = [
	'hostid' =>				[T_BS_INT, O_OPT, P_SYS,	DB_ID,		'!isset({form})'],
	...
	'type' =>				[T_BS_INT, O_OPT, null,
		IN([-1, ITEM_TYPE_BSM, ITEM_TYPE_SNMPV1, ITEM_TYPE_TRAPPER, ITEM_TYPE_SIMPLE, ITEM_TYPE_SNMPV2C,
			ITEM_TYPE_INTERNAL, ITEM_TYPE_SNMPV3, ITEM_TYPE_BSM_ACTIVE, ITEM_TYPE_EXTERNAL, ITEM_TYPE_DB_MONITOR,
	...
	'lifetime' => 			[T_BS_STR, O_OPT, null,	null,		'isset({add}) || isset({update})'],
	'evaltype' =>	 		[T_BS_INT, O_OPT, null, 	IN($evalTypes), 'isset({add}) || isset({update})'],
	'formula' => 			[T_BS_STR, O_OPT, null,	null,		'isset({add}) || isset({update})'],
	'conditions' =>			[T_BS_STR, O_OPT, P_SYS,	null,		null],
	// actions
	'action' =>				[T_BS_STR, O_OPT, P_SYS|P_ACT,
								IN('"discoveryrule.massdelete","discoveryrule.massdisable","discoveryrule.massenable"'),
								null
							],
	'g_hostdruleid' =>		[T_BS_INT, O_OPT, null,	DB_ID,		null],
	...
	// sort and sortorder
	'sort' =>				[T_BS_STR, O_OPT, P_SYS, IN('"delay","key_","name","status","type"'),	null],
