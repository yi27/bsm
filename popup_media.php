...
$fields = [
	...
	'media'=>		[T_BS_INT, O_OPT,	P_SYS,	null,			null],
	'mediatypeid'=>	[T_BS_INT, O_OPT,	P_SYS,	DB_ID,			'isset({add})'],
	'sendto'=>		[T_BS_STR, O_OPT,	null,	NOT_EMPTY,		'isset({add})'],
	'period'=>		[T_BS_STR, O_OPT,	null,	NOT_EMPTY,		'isset({add})'],
	'active'=>		[T_BS_INT, O_OPT,	null,	IN([MEDIA_STATUS_ACTIVE, MEDIA_STATUS_DISABLED]), null],

	'severity'=>	[T_BS_INT, O_OPT,	null,	NOT_EMPTY,	null],
/* actions */
...
if (isset($_REQUEST['add'])) {
	...
	if ($validator->validate($_REQUEST['period'])) {
		...
		echo '<script type="text/javascript">
				...
				$_REQUEST['media'].','.
				bs_jsvalue($_REQUEST['mediatypeid']).','.
...
$period = getRequest('period', BS_DEFAULT_INTERVAL);
...
$frmMedia = (new CFormList(_('Media')))
	...
	->addRow(_('Send to'), (new CTextBox('sendto', $sendto, false, 100))->setWidth(BS_TEXTAREA_STANDARD_WIDTH))
	->addRow(_('When active'), (new CTextBox('period', $period, false, 100))->setWidth(BS_TEXTAREA_STANDARD_WIDTH))
