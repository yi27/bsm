...
$fields = [
	...
	'expr_temp' =>			[T_BS_STR, O_OPT, null,	NOT_EMPTY,	'(isset({add_expression}) || isset({and_expression}) || isset({or_expression}) || isset({replace_expression}))'],
	...
	'new_dependency' =>		[T_BS_INT, O_OPT, null,	DB_ID.NOT_ZERO, 'isset({add_dependency})'],
...
if (!is_array($triggerPrototypeIds)) {
	$triggerPrototypeIds = bs_toArray($triggerPrototypeIds);
}
...
elseif (hasRequest('add') || hasRequest('update')) {
	...
	if (hasRequest('update')) {
		...
		$old_trigger_prototype['dependencies'] = bs_toHash(
			bs_objectValues($old_trigger_prototype['dependencies'], 'triggerid')
		);
		...
		$trigger['flags'] = BS_FLAG_DISCOVERY_PROTOTYPE;
