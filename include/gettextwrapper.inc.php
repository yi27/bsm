 ...
 *
 * Examples:
 * _n('%2$s item on host %1$s', '%2$s items on host %1$s', 'Bsm server', 1) // 1 item on host Bsm server
 * _n('%2$s item on host %1$s', '%2$s items on host %1$s', 'Bsm server', 2) // 2 items on host Bsm server
 *
