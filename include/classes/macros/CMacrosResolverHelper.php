...
class CMacrosResolverHelper {
	...
	public static function resolveTriggerNameByIds(array $triggerIds) {
		...
		return self::$macrosResolver->resolveTriggerNames(bs_toHash($triggers, 'triggerid'), [
	...
	public static function resolveTriggerExpressionUserMacro(array $trigger) {
		...
		$triggers = self::$macrosResolver->resolveTriggerExpressionUserMacro(bs_toHash([$trigger], 'triggerid'));
