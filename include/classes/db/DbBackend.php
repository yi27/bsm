...
abstract class DbBackend {
	...
	public function checkDbVersion() {
		...
		if ($version['mandatory'] != BSM_DB_VERSION) {
			$this->setError(_s('The frontend does not match Bsm database. Current database version (mandatory/optional): %d/%d. Required mandatory version: %d. Contact your system administrator.',
				$version['mandatory'], $version['optional'], BSM_DB_VERSION));
			return false;
		}
