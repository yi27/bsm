...
<html>
	<head>
		...
		<title>业务网管系统</title>
		<link rel="icon" href="img/con-l-logo.ico">
		<link rel="apple-touch-icon-precomposed" sizes="76x76" href="img/con-l-logo.jpg">
		<link rel="apple-touch-icon-precomposed" sizes="120x120" href="img/con-l-logo.jpg">
		<link rel="apple-touch-icon-precomposed" sizes="152x152" href="img/con-l-logo.jpg">
		<link rel="apple-touch-icon-precomposed" sizes="180x180" href="img/con-l-logo.jpg">
		<link rel="icon" sizes="192x192" href="img/con-l-logo.ico">
