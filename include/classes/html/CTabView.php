...
class CTabView extends CDiv {
	...
	public function __construct($data = []) {
		...
		parent::__construct();
		$this->setId(bs_formatDomId($this->id));
		$this->addClass(BS_STYLE_TABLE_FORMS_CONTAINER);
	}
	...
	public function addTab($id, $header, $body) {
		...
		$this->tabs[$id]->setId(bs_formatDomId($id));
		return $this;
	}
	...
	public function toString($destroy = true) {
		...
		if (count($this->tabs) == 1) {
			...
			$headersList = (new CList())->addClass(BS_STYLE_TABS_NAV);
