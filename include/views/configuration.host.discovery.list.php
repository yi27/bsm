...
$discoveryTable = (new CTableInfo())
	->setHeader([
		...
		_('Triggers'),
		_('Graphs'),
		($data['host']['flags'] == BS_FLAG_DISCOVERY_NORMAL) ? _('Hosts') : null,
...
foreach ($data['discoveries'] as $discovery) {
	...
	if ($data['showInfoColumn']) {
		if ($discovery['status'] == ITEM_STATUS_ACTIVE && !bs_empty($discovery['error'])) {
	...
	if ($data['host']['flags'] == BS_FLAG_DISCOVERY_NORMAL) {
		$hostPrototypeLink = [
