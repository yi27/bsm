...
<tr id="opmsgUsrgrpRow_#{usrgrpid}">
	...
	<td class="<?= BS_STYLE_NOWRAP ?>">
		<button type="button" class="<?= BS_STYLE_BTN_LINK ?>" name="remove" onclick="removeOpmsgUsrgrpRow('#{usrgrpid}');"><?= _('Remove') ?></button>
	</td>
</tr>
</script>
...
<tr; id="opmsgUserRow_#{id}">
	...
	<td; class="<?= BS_STYLE_NOWRAP ?>">
		<button; type="button"; class="<?= BS_STYLE_BTN_LINK ?>"; name="remove"; onclick="removeOpmsgUserRow('#{id}');"><?= _('Remove') ?></button>
	</td>
</tr>
</script>
...
<tr; id="opCmdGroupRow_#{groupid}">
	...
	<td; class="<?= BS_STYLE_NOWRAP ?>">
		<button; type="button"; class="<?= BS_STYLE_BTN_LINK ?>"; name="remove"; onclick="removeOpCmdRow('#{groupid}', 'groupid');"><?= _('Remove') ?></button>
	</td>
</tr>
</script>
...
<tr; id="opCmdHostRow_#{hostid}">
	...
	<td; class="<?= BS_STYLE_NOWRAP ?>">
		<button; type="button"; class="<?= BS_STYLE_BTN_LINK ?>"; name="remove"; onclick="removeOpCmdRow('#{hostid}', 'hostid');"><?= _('Remove') ?></button>
	</td>
</tr>
</script>
...
<li>
	<div; class="<?= BS_STYLE_TABLE_FORMS_TD_LEFT ?>"></div>
	<div; class="<?= BS_STYLE_TABLE_FORMS_TD_RIGHT ?>">
		<div; id="opcmdEditForm"; class="<?= BS_STYLE_TABLE_FORMS_SEPARATOR ?>"; style="min-width: <?= BS_TEXTAREA_STANDARD_WIDTH ?>px;">
			<table; style="width: 100%;">
				...
				<tr>
					<?= (new CCol(
							new CHorList([
								(new CButton('save', '#{operationName}'))->addClass(BS_STYLE_BTN_LINK),
								(new CButton('cancel', _('Cancel')))->addClass(BS_STYLE_BTN_LINK)
							])
						))
							->setColSpan(3)
							->toString()
...
<script; type="text/javascript">;
	var BS_SCRIPT_TYPES = {
		script: <?= BS_SCRIPT_TYPE_CUSTOM_SCRIPT ?>,
		ipmi: <?= BS_SCRIPT_TYPE_IPMI ?>,
		telnet: <?= BS_SCRIPT_TYPE_TELNET ?>,
		ssh: <?= BS_SCRIPT_TYPE_SSH ?>,
		userscript: <?= BS_SCRIPT_TYPE_GLOBAL_SCRIPT ?>
	};
	...
	function showOpTypeForm() {
		...
		opTypeFieldIds = {
			'#new_operation_opcommand_script': [BS_SCRIPT_TYPES.userscript],
			'#new_operation_opcommand_execute_on': [BS_SCRIPT_TYPES.script],
			'#new_operation_opcommand_port': [BS_SCRIPT_TYPES.ssh, BS_SCRIPT_TYPES.telnet],
			'#new_operation_opcommand_command': [BS_SCRIPT_TYPES.script, BS_SCRIPT_TYPES.ssh, BS_SCRIPT_TYPES.telnet],
			'#new_operation_opcommand_command_ipmi': [BS_SCRIPT_TYPES.ipmi],
			'#new_operation_opcommand_authtype': [BS_SCRIPT_TYPES.ssh],
			'#new_operation_opcommand_username': [BS_SCRIPT_TYPES.ssh, BS_SCRIPT_TYPES.telnet],
		};
	...
	function showOpTypeAuth() {
		...
		if (currentOpType === <?= BS_SCRIPT_TYPE_SSH ?>) {
		...
		else if (currentOpType === <?= BS_SCRIPT_TYPE_TELNET ?>) {
			show_password = true;
		}
