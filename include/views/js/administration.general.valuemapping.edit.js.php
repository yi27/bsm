<script type="text/x-jquery-tmpl" id="mapping_row">
	<?= (new CRow([
			(new CTextBox('mappings[#{rowNum}][value]', '', false, 64))->setWidth(BS_TEXTAREA_SMALL_WIDTH),
			'&rArr;',
			(new CTextBox('mappings[#{rowNum}][newvalue]', '', false, 64))->setWidth(BS_TEXTAREA_SMALL_WIDTH),
