...
if ($this->data['displayInterfaces']) {
	...
	$interfaceGroups = [];
	foreach (bs_objectValues($this->data['hosts']['interfaces'], 'type') as $interfaceType) {
...
$itemFormList->addRow(
	...
	(new CTextBox('snmp_community', $this->data['snmp_community']))->setWidth(BS_TEXTAREA_STANDARD_WIDTH)
);
...
$itemFormList->addRow(
	...
	(new CTextBox('snmpv3_securityname', $this->data['snmpv3_securityname']))->setWidth(BS_TEXTAREA_STANDARD_WIDTH)
);
...
$itemFormList->addRow(
	...
	(new CTextBox('port', $this->data['port']))->setWidth(BS_TEXTAREA_SMALL_WIDTH)
);
...
$itemFormList->addRow(
	...
	(new CTextBox('units', $this->data['units']))->setWidth(BS_TEXTAREA_STANDARD_WIDTH)
);
...
$itemFormList->addRow(
	...
	(new CTextBox('username', $this->data['username']))->setWidth(BS_TEXTAREA_SMALL_WIDTH)
);
...
$itemFormList->addRow(
	...
	(new CTextBox('publickey', $this->data['publickey']))->setWidth(BS_TEXTAREA_SMALL_WIDTH)
);
...
$itemFormList->addRow(
	...
	(new CTextBox('privatekey', $this->data['privatekey']))->setWidth(BS_TEXTAREA_SMALL_WIDTH)
);
...
$itemFormList->addRow(
	...
	(new CTextBox('password', $this->data['password']))->setWidth(BS_TEXTAREA_SMALL_WIDTH)
);
...
$itemFormList->addRow(
	...
	->addRow(
		...
		(new CNumericBox('history', $this->data['history'], 8))->setWidth(BS_TEXTAREA_NUMERIC_STANDARD_WIDTH)
)
	->addRow(
		[
		...
		(new CNumericBox('trends', $this->data['trends'], 8))->setWidth(BS_TEXTAREA_NUMERIC_STANDARD_WIDTH)
);
...
$itemFormList->addRow(
	...
	(new CTextBox('logtimefmt', $this->data['logtimefmt']))->setWidth(BS_TEXTAREA_STANDARD_WIDTH)
);
