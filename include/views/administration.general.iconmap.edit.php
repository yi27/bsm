...
foreach ($this->data['iconmap']['mappings'] as $mapping) {
	...
	$iconPreviewImage = (new CImg('imgstore.php?iconid='.$mapping['iconid'].'&width='.BS_ICON_PREVIEW_WIDTH.
		'&height='.BS_ICON_PREVIEW_HEIGHT, _('Preview'), null, null))
		->addClass('preview')
...
$iconMapTable->addRow((new CRow([
	(new CCol(
		(new CButton('addMapping', _('Add')))->addClass(BS_STYLE_BTN_LINK)
	))->setColSpan(7)
...
$iconPreviewImage = (new CImg('imgstore.php?iconid='.$this->data['iconmap']['default_iconid'].
	'&width='.BS_ICON_PREVIEW_WIDTH.'&height='.BS_ICON_PREVIEW_HEIGHT, _('Preview'), null, null))
	->addClass(BS_STYLE_CURSOR_POINTER)
	->addClass('preview')
