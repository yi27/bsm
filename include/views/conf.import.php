...
foreach ($titles as $key => $title) {
	...
	$rulesTable->addRow([
		$title,
		(new CCol($cbExist))->addClass(BS_STYLE_CENTER),
		(new CCol($cbMissed))->addClass(BS_STYLE_CENTER),
		(new CCol($cbDeleted))->addClass(BS_STYLE_CENTER)
	]);
}

// form list
$form_list = (new CFormList())
	->addRow(_('Import file'), (new CFile('import_file'))->setWidth(BS_TEXTAREA_STANDARD_WIDTH))
