...
$screen_tab->addRow(_('Name'),
	...
	->addRow(_('Columns'),
		(new CNumericBox('hsize', $data['screen']['hsize'], 3))->setWidth(BS_TEXTAREA_NUMERIC_STANDARD_WIDTH)
	)
	->addRow(_('Rows'),
		(new CNumericBox('vsize', $data['screen']['vsize'], 3))->setWidth(BS_TEXTAREA_NUMERIC_STANDARD_WIDTH)
	);
