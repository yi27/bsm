...
$ipmiFormList->addRow(
	...
	(new CTextBox('ipmi_username', $data['ipmi_username']))->setWidth(BS_TEXTAREA_SMALL_WIDTH)
);
...
$ipmiFormList->addRow(
	...
	(new CTextBox('ipmi_password', $data['ipmi_password']))->setWidth(BS_TEXTAREA_SMALL_WIDTH)
);
