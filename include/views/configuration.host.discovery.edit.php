...
$itemFormList->addRow(_('User name'),
	(new CTextBox('username', $this->data['username'], false, 64))->setWidth(BS_TEXTAREA_SMALL_WIDTH),
	'row_username'
);
...
$itemFormList->addRow(_('Custom intervals'),
	...
	->addRow(_('Keep lost resources period (in days)'),
		(new CTextBox('lifetime', $this->data['lifetime'], false, 64))->setWidth(BS_TEXTAREA_SMALL_WIDTH)
	)
...
foreach ($conditions as $i => $condition) {
	...
	$macro = (new CTextBox('conditions['.$i.'][macro]', $condition['macro'], false, 64))
		->setWidth(BS_TEXTAREA_MACRO_WIDTH)
		->addClass(BS_STYLE_UPPERCASE)
		->addClass('macro')
	...
	$value = (new CTextBox('conditions['.$i.'][value]', $condition['value'], false, 255))
		->setWidth(BS_TEXTAREA_MACRO_VALUE_WIDTH)
	...
	$row = [$formulaId, $macro, new CSpan(_('matches')), $value,
		(new CCol($deleteButtonCell))->addClass(BS_STYLE_NOWRAP)
	];
