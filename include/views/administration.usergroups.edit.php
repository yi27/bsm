...
$permissionsTable->addRow([
	[
		...
		(new CSubmit('del_read_write', _('Delete selected')))->addClass(BS_STYLE_BTN_GREY)
	],
	[
		...
		(new CDiv())->addClass(BS_STYLE_FORM_INPUT_MARGIN),
		(new CSubmit('del_read_only', _('Delete selected')))->addClass(BS_STYLE_BTN_GREY)
	],
	[
		...
		(new CDiv())->addClass(BS_STYLE_FORM_INPUT_MARGIN),
		(new CSubmit('del_deny', _('Delete selected')))->addClass(BS_STYLE_BTN_GREY)
	]
]);
$permissionsFormList
