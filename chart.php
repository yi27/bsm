...
$fields = [
	'type' =>           [T_BS_INT, O_OPT, null,   IN([GRAPH_TYPE_NORMAL, GRAPH_TYPE_STACKED]), null],
	'itemids' =>		[T_BS_INT, O_MAND, P_SYS,	DB_ID,		null],
	...
	'from' =>			[T_BS_INT, O_OPT, null,	'{} >= 0',	null],
	'width' =>			[T_BS_INT, O_OPT, null,	BETWEEN(20, 65535),	null],
	'height' =>			[T_BS_INT, O_OPT, null,	'{} > 0',	null],
	'batch' =>			[T_BS_INT, O_OPT, null,	IN('0,1'),	null],
];
