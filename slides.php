...
$fields = [
	...
	'elementid' =>		[T_BS_INT, O_OPT, P_SYS|P_NZERO, DB_ID, null],
	'step' =>			[T_BS_INT, O_OPT, P_SYS,	BETWEEN(0, 65535), null],
	'period' =>			[T_BS_INT, O_OPT, P_SYS,	null,	null],
	'stime' =>			[T_BS_STR, O_OPT, P_SYS,	null,	null],
	'reset' =>			[T_BS_STR, O_OPT, P_SYS,	IN('"reset"'), null],
	'fullscreen' =>		[T_BS_INT, O_OPT, P_SYS,	IN('0,1'), null],
	// ajax
	'widgetRefresh' =>	[T_BS_STR, O_OPT, null,	null,	null],
	'widgetRefreshRate' => [T_BS_STR, O_OPT, P_ACT, null,	null],
	'favobj' =>			[T_BS_STR, O_OPT, P_ACT,	null,	null],
	'favid' =>			[T_BS_INT, O_OPT, P_ACT,	null,	null],
	'upd_counter' =>	[T_BS_INT, O_OPT, P_ACT,	null,	null]
];
check_fields($fields);
