...
$fields = [
	...
	'selementid' =>	[T_BS_INT, O_OPT, P_SYS,	DB_ID,		null],
	'sysmap' =>		[T_BS_STR, O_OPT, null,	NOT_EMPTY,	'isset({action})'],
	'selements' =>	[T_BS_STR, O_OPT, P_SYS,	null,		null],
	'links' =>		[T_BS_STR, O_OPT, P_SYS,	null,		null],
	// actions
	'action' =>		[T_BS_STR, O_OPT, P_ACT,	IN('"update"'),	null],
	...
	'favid' =>		[T_BS_STR, O_OPT, P_ACT,	null,		null]
];
check_fields($fields);
...
$data['sysmap']['selements'] = bs_toHash($data['sysmap']['selements'], 'selementid');
$data['sysmap']['links'] = bs_toHash($data['sysmap']['links'], 'linkid');
