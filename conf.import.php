...
$fields = [
	'rules' => [T_BS_STR, O_OPT, null, null, null],
	'import' => [T_BS_STR, O_OPT, P_SYS|P_ACT, null, null],
	'rules_preset' => [T_BS_STR, O_OPT, null, null, null],
	'backurl' => [T_BS_STR, O_OPT, null, null, null],
...
$data = [
	...
	'backurl' => getRequest('backurl', 'bsm.php?action=dashboard.view')
];
