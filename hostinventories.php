...
$fields = [
	...
	'filter_field' =>		[T_BS_STR, O_OPT, null,	null,		null],
	'filter_field_value' =>	[T_BS_STR, O_OPT, null,	null,		null],
	'filter_exact' =>		[T_BS_INT, O_OPT, null,	'IN(0,1)',	null],
	// sort and sortorder
...
if ($hostId > 0) {
	...
	$data['tableTitles'] = bs_toHash($data['tableTitles'], 'db_field');
	...
	elseif ($userType == USER_TYPE_BSM_ADMIN) {
		$rwHost = API::Host()->get([
			'output' => ['hostid'],
			'hostids' => $hostId,
			'editable' => true
	...
	if ($data['pageFilter']->groupsSelected) {
		...
		$possibleInventoryFields = bs_toHash($possibleInventoryFields, 'db_field');
