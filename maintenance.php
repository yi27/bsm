...
$fields = [
	...
	// maintenance
	'maintenanceid' =>						[T_BS_INT, O_OPT, P_SYS,	DB_ID,		'isset({form}) && {form} == "update"'],
	'maintenanceids' =>						[T_BS_INT, O_OPT, P_SYS,	DB_ID, 		null],
	'mname' =>								[T_BS_STR, O_OPT, null,	NOT_EMPTY,	'isset({add}) || isset({update})', _('Name')],
	'maintenance_type' =>					[T_BS_INT, O_OPT, null,	null,		'isset({add}) || isset({update})'],
	'description' =>						[T_BS_STR, O_OPT, null,	null,		'isset({add}) || isset({update})'],
	'active_since' =>						[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	'isset({add}) || isset({update})'],
	'active_till' =>						[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	'isset({add}) || isset({update})'],
	'active_since_day' =>					[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'active_since_month' =>					[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'active_since_year' =>					[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'active_since_hour' =>					[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'active_since_minute' =>				[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'active_till_day' =>					[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'active_till_month' =>					[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'active_till_year' =>					[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'active_till_hour' =>					[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'active_till_minute' =>					[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'new_timeperiod_start_date_day' =>		[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'new_timeperiod_start_date_month' =>	[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'new_timeperiod_start_date_year' =>		[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'new_timeperiod_start_date_hour' =>		[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'new_timeperiod_start_date_minute' =>	[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'new_timeperiod' =>						[T_BS_STR, O_OPT, null,	null,		'isset({add_timeperiod})'],
	'timeperiods' =>						[T_BS_STR, O_OPT, null,	null,		null],
	'del_timeperiodid' =>					[T_BS_STR, O_OPT, P_ACT,	null,		null],
	'edit_timeperiodid' =>					[T_BS_STR, O_OPT, P_ACT,	null,		null],
	'twb_groupid' =>						[T_BS_INT, O_OPT, P_SYS,	DB_ID,		null],
	// actions
	'action' =>								[T_BS_STR, O_OPT, P_SYS|P_ACT, IN('"maintenance.massdelete"'), null],
	'add_timeperiod' =>						[T_BS_STR, O_OPT, P_SYS|P_ACT, null,	null],
	'cancel_new_timeperiod' =>				[T_BS_STR, O_OPT, P_SYS|P_ACT, null,	null],
	...
	'sortorder' =>							[T_BS_STR, O_OPT, P_SYS, IN('"'.BS_SORT_DOWN.'","'.BS_SORT_UP.'"'),
												null
											]
];
...
if (!empty($data['form'])) {
	...
	if (isset($data['maintenanceid']) && !isset($_REQUEST['form_refresh'])) {
		...
		$data['hostids'] = bs_objectValues($data['hostids'], 'hostid');
		...
		$data['groupids'] = bs_objectValues($data['groupids'], 'groupid');
	}
	else {
	...
	$data['hosts'] = bs_toHash($data['hosts'], 'hostid');
	...
	$data['maintenances'] = API::Maintenance()->get([
		'output' => API_OUTPUT_EXTEND,
		'maintenanceids' => bs_objectValues($data['maintenances'], 'maintenanceid')
	]);
