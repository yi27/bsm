...
$fields = [
	'iconmapid' =>		[T_BS_INT, O_OPT, P_SYS,			DB_ID,	'(isset({form}) && {form} == "update") || isset({delete})'],
	'iconmap' =>		[T_BS_STR, O_OPT, null,			null,	'isset({add}) || isset({update})'],
	...
	'clone' =>			[T_BS_STR, O_OPT, null,			null,	null],
