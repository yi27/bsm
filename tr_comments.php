...
$fields = [
	...
	'comments' =>	[T_BS_STR, O_OPT, null,			null,	'isset({update})'],
	// actions
	'update' =>		[T_BS_STR, O_OPT, P_SYS|P_ACT,	null,	null],
	'cancel' =>		[T_BS_STR, O_OPT, P_SYS|P_ACT,	null,	null]
];
check_fields($fields);
...
if (hasRequest('update')) {
	...
	$result = DBexecute(
		'UPDATE triggers'.
		' SET comments='.bs_dbstr(getRequest('comments')).
		' WHERE triggerid='.bs_dbstr(getRequest('triggerid'))
	);
