...
$functions = [
	...
	'fuzzytime[=]' => [
		'description' =>  _('Difference between item timestamp value and Bsm server timestamp is over T seconds, then N = 0, 1 - otherwise'),
		'params' => $param1Sec,
		'allowed_types' => $allowedTypesAny
	],
	'fuzzytime[<>]' => [
		'description' =>  _('Difference between item timestamp value and Bsm server timestamp is over T seconds, then N NOT 0, 1 - otherwise'),
		'params' => $param1Sec,
		'allowed_types' => $allowedTypesAny
	],
	'regexp[=]' => [
...
$fields = [
	...
	'dstfld1' =>			[T_BS_STR, O_MAND, P_SYS, NOT_EMPTY,	null],
	'expression' =>			[T_BS_STR, O_OPT, null,	null,		null],
	'itemid' =>				[T_BS_INT, O_OPT, null,	null,		'isset({insert})'],
	'parent_discoveryid' =>	[T_BS_INT, O_OPT, null,	null,		null],
	'expr_type'=>			[T_BS_STR, O_OPT, null,	NOT_EMPTY,	'isset({insert})'],
	'params' =>				[T_BS_STR, O_OPT, null,	0,			null],
	'paramtype' =>			[T_BS_INT, O_OPT, null,	IN(PARAM_TYPE_TIME.','.PARAM_TYPE_COUNTS), 'isset({insert})'],
	'value' =>				[T_BS_STR, O_OPT, null,	NOT_EMPTY,	'isset({insert})'],
	// action
	'insert' =>				[T_BS_STR, O_OPT, P_SYS|P_ACT, null,	null],
