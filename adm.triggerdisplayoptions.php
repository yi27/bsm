...
$fields = [
	'problem_unack_color' =>	[T_BS_CLR, O_OPT, null, null, 'isset({update})',
		_('Unacknowledged PROBLEM events')
	],
	'problem_ack_color' =>		[T_BS_CLR, O_OPT, null, null, 'isset({update})',
		_('Acknowledged PROBLEM events')
	],
	'ok_unack_color' =>			[T_BS_CLR, O_OPT, null, null, 'isset({update})', _('Unacknowledged OK events')],
	'ok_ack_color' =>			[T_BS_CLR, O_OPT, null, null, 'isset({update})', _('Acknowledged OK events')],
	'problem_unack_style' =>	[T_BS_INT, O_OPT, null, IN('1'), null, _('Blinking')],
	'problem_ack_style' =>		[T_BS_INT, O_OPT, null, IN('1'), null, _('Blinking')],
	'ok_unack_style' =>			[T_BS_INT, O_OPT, null, IN('1'), null, _('Blinking')],
	'ok_ack_style' =>			[T_BS_INT, O_OPT, null, IN('1'), null, _('Blinking')],
	'ok_period' =>				[T_BS_INT, O_OPT, null, BETWEEN(0, 999999), 'isset({update})',
		_('Display OK triggers for')
	],
	'blink_period' =>			[T_BS_INT, O_OPT, null, BETWEEN(0, 999999), 'isset({update})',
