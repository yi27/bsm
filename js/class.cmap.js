...
BSM.namespace = function(namespace) {
...
BSM.namespace('classes.Observer');

BSM.classes.Observer = (function() {
	var Observer = function() {
		this.listeners = {};
	};

	Observer.prototype = {
		constructor: BSM.classes.Observer,
...
BSM.namespace('apps.map');

BSM.apps.map = (function($) {
	// dependencies
	var Observer = BSM.classes.Observer;
