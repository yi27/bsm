...
function initMessages(args) {
	var messagesListId = BS_MESSAGES.length;
	BS_MESSAGES[messagesListId] = new CMessageList(messagesListId, args);
...
var CMessageList = Class.create({
	...
	createContainer: function() {
		this.dom.container = $('bs_messages');
		...
		this.dom.container.setAttribute('id', 'bs_messages');
