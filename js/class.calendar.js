...
calendar.prototype = {
	...
	monthname: [locale['S_JANUARY'], locale['S_FEBRUARY'], locale['S_MARCH'], locale['S_APRIL'], locale['S_MAY'], locale['S_JUNE'], locale['S_JULY'], locale['S_AUGUST'], locale['S_SEPTEMBER'], locale['S_OCTOBER'], locale['S_NOVEMBER'], locale['S_DECEMBER']],
	...
	setSDateFromOuterObj: function() {
		...
		if (!is_null(this.clndr_utime_field)) {
			this.clndr_utime_field.value = this.sdt.getBSDate();
		}
		return true;
	},
