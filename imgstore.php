...
define('BS_PAGE_NO_AUTHERIZATION', 1);
...
$fields = [
	'css' =>		[T_BS_INT, O_OPT, P_SYS, null,				null],
	'imageid' =>	[T_BS_STR, O_OPT, P_SYS, null,				null],
	'iconid' =>		[T_BS_INT, O_OPT, P_SYS, DB_ID,				null],
	'width' =>		[T_BS_INT, O_OPT, P_SYS, BETWEEN(1, 2000),	null],
	'height' =>		[T_BS_INT, O_OPT, P_SYS, BETWEEN(1, 2000),	null],
];
check_fields($fields);
