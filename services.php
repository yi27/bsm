...
$fields = [
	'serviceid' =>						[T_BS_INT, O_OPT, P_SYS,	DB_ID,		null],
	'name' => 							[T_BS_STR, O_OPT, null,	NOT_EMPTY, 'isset({add}) || isset({update})', _('Name')],
	'algorithm' =>						[T_BS_INT, O_OPT, null,	IN('0,1,2'),'isset({add}) || isset({update})'],
	'showsla' =>						[T_BS_INT, O_OPT, null,	IN('0,1'),	null],
	'goodsla' => 						[T_BS_DBL, O_OPT, null,	BETWEEN(0, 100), null, _('Calculate SLA, acceptable SLA (in %)')],
	'sortorder' => 						[T_BS_INT, O_OPT, null,	BETWEEN(0, 999), null, _('Sort order (0->999)')],
	'times' =>							[T_BS_STR, O_OPT, null,	null,		null],
	'triggerid' =>						[T_BS_INT, O_OPT, P_SYS,	DB_ID,		null],
	'trigger' =>						[T_BS_STR, O_OPT, null,	null,		null],
	'new_service_time' =>				[T_BS_STR, O_OPT, null,	null,		null],
	'new_service_time_from_day' =>		[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'new_service_time_from_month' =>	[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'new_service_time_from_year' =>		[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'new_service_time_from_hour' =>		[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'new_service_time_from_minute' =>	[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'new_service_time_to_day' =>		[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'new_service_time_to_month' =>		[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'new_service_time_to_year' =>		[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'new_service_time_to_hour' =>		[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'new_service_time_to_minute' =>		[T_BS_STR, O_OPT, null, 	NOT_EMPTY,	null],
	'children' =>						[T_BS_STR, O_OPT, P_SYS,	null,		null],
	'parentid' =>						[T_BS_INT, O_OPT, P_SYS,	DB_ID,		null],
	'parentname' =>						[T_BS_STR, O_OPT, null,	null,		null],
	// actions
	'add' =>							[T_BS_STR, O_OPT, P_SYS|P_ACT, null,	null],
	'update' =>							[T_BS_STR, O_OPT, P_SYS|P_ACT, null,	null],
	'add_service_time' =>				[T_BS_STR, O_OPT, P_SYS|P_ACT, null,	null],
	'delete' =>							[T_BS_STR, O_OPT, P_SYS|P_ACT,	null,		null],
	// others
	'form' =>							[T_BS_STR, O_OPT, P_SYS,	null,		null],
	'form_refresh' =>					[T_BS_INT, O_OPT, null,	null,		null],
	'pservices' =>						[T_BS_INT, O_OPT, null,	null,		null],
	'cservices' =>						[T_BS_INT, O_OPT, null,	null,		null]
];
check_fields($fields);
...
if (isset($_REQUEST['pservices'])) {
	...
	$triggers = bs_objectValues(
		array_filter($parentServices, function($service) { return (bool) $service['trigger']; }), 'trigger'
	);
	$triggers = CMacrosResolverHelper::resolveTriggerNames(bs_toHash($triggers, 'triggerid'));
...
elseif (isset($_REQUEST['form'])) {
	...
	if (isset($data['service']['serviceid']) && !isset($_REQUEST['form_refresh'])) {
		...
		if ($service['dependencies']) {
			$childServices = API::Service()->get([
				'serviceids' => bs_objectValues($service['dependencies'], 'servicedownid'),
				'selectTrigger' => ['triggerid', 'description', 'expression'],
