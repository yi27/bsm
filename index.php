...
$fields = [
	'name' =>		[T_BS_STR, O_NO,	null,	null,		'isset({enter})', _('Username')],
	'password' =>	[T_BS_STR, O_OPT, null,	null,			'isset({enter})'],
	'sessionid' =>	[T_BS_STR, O_OPT, null,	null,			null],
	'reconnect' =>	[T_BS_INT, O_OPT, P_SYS|P_ACT,	BETWEEN(0, 65535), null],
	'enter' =>		[T_BS_STR, O_OPT, P_SYS,	null,			null],
	'autologin' =>	[T_BS_INT, O_OPT, null,	null,			null],
	'request' =>	[T_BS_STR, O_OPT, null,	null,			null]
];
check_fields($fields);
...
if ($config['authentication_type'] == BS_AUTH_HTTP) {
...
// login via form
if (isset($_REQUEST['enter']) && $_REQUEST['enter'] == _('登陆')) {
	// try to login
	...
	if ($loginSuccess) {
		...
		elseif (!bs_empty(CWebUser::$data['url'])) {
...
if (!CWebUser::$data['alias'] || CWebUser::$data['alias'] == BS_GUEST_USER) {
	...
	redirect(bs_empty(CWebUser::$data['url']) ? BS_DEFAULT_URL : CWebUser::$data['url']);
}
