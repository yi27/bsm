...
$fields = [
	'period' =>			[T_BS_INT, O_OPT, P_NZERO,	BETWEEN(BS_MIN_PERIOD, BS_MAX_PERIOD), null],
	'stime' =>			[T_BS_INT, O_OPT, P_NZERO,	null,				null],
	'profileIdx' =>		[T_BS_STR, O_OPT, null,		null,				null],
	'profileIdx2' =>	[T_BS_STR, O_OPT, null,		null,				null],
	'httptestid' =>		[T_BS_INT, O_OPT, P_NZERO,	null,				null],
	'http_item_type' =>	[T_BS_INT, O_OPT, null,		null,				null],
	'name' =>			[T_BS_STR, O_OPT, null,		null,				null],
	'width' =>			[T_BS_INT, O_OPT, null,		BETWEEN(20, 65535),	null],
	'height' =>			[T_BS_INT, O_OPT, null,		BETWEEN(0, 65535),	null],
	'ymin_type' =>		[T_BS_INT, O_OPT, null,		IN('0,1,2'),		null],
	'ymax_type' =>		[T_BS_INT, O_OPT, null,		IN('0,1,2'),		null],
	'ymin_itemid' =>	[T_BS_INT, O_OPT, null,		DB_ID,				null],
	'ymax_itemid' =>	[T_BS_INT, O_OPT, null,		DB_ID,				null],
	'legend' =>			[T_BS_INT, O_OPT, null,		IN('0,1'),			null],
	'showworkperiod' =>	[T_BS_INT, O_OPT, null,		IN('0,1'),			null],
	'showtriggers' =>	[T_BS_INT, O_OPT, null,		IN('0,1'),			null],
	'graphtype' =>		[T_BS_INT, O_OPT, null,		IN('0,1'),			null],
	'yaxismin' =>		[T_BS_DBL, O_OPT, null,		null,				null],
	'yaxismax' =>		[T_BS_DBL, O_OPT, null,		null,				null],
	'percent_left' =>	[T_BS_DBL, O_OPT, null,		BETWEEN(0, 100),	null],
	'percent_right' =>	[T_BS_DBL, O_OPT, null,		BETWEEN(0, 100),	null],
...
if ($httptestid = getRequest('httptestid', false)) {
	...
	$dbItems = DBselect(
		...
		' WHERE i.itemid=hi.itemid'.
			...
			' AND hi.type='.bs_dbstr(getRequest('http_item_type', HTTPSTEP_ITEM_TYPE_TIME)).
		' ORDER BY hs.no DESC'
	);
