...
$fields = [
	'sysmapid' =>		[T_BS_INT, O_MAND, P_SYS,	DB_ID,				null],
	'selements' =>		[T_BS_STR, O_OPT, P_SYS,	null,				null],
	'links' =>			[T_BS_STR, O_OPT, P_SYS,	null,				null],
	'noselements' =>	[T_BS_INT, O_OPT, null,	IN('0,1'),			null],
	'nolinks' =>		[T_BS_INT, O_OPT, null,	IN('0,1'),			null],
	'nocalculations' =>	[T_BS_INT, O_OPT, null,	IN('0,1'),			null],
	'expand_macros' =>	[T_BS_INT, O_OPT, null,	IN('0,1'),			null],
	'show_triggers' =>	[T_BS_INT, O_OPT, P_SYS,	IN('0,1,2,3'),		null],
	'severity_min' =>	[T_BS_INT, O_OPT, null,	IN('0,1,2,3,4,5'),	null],
	'grid' =>			[T_BS_INT, O_OPT, null,	BETWEEN(0, 500),	null],
	'base64image' =>	[T_BS_INT, O_OPT, null,	IN('0,1'),			null]
];
check_fields($fields);
...
if (getRequest('nocalculations', false)) {
	...
	$map['selements'] = bs_toHash($map['selements'], 'selementid');
